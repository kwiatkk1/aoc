...
const expectedTestPart1 = 152;
const expectedTestPart2 = 301;
...
if (expectedTestPart1) {
  ...
  console.log({ solution: solvePart1(inputReal), right: 54703080378102 });
}
...
if (expectedTestPart2) {
  ...
  console.log({ solution: solvePart2(inputReal), right: 3952673930912 });
}
