...
const expectedTestPart1 = '';
const expectedTestPart2 = 56000011;

if (expectedTestPart1) {
  const outputTest = solvePart1(inputTest, 10);
  console.log("part1", {
  ...
  console.log({ solution: solvePart1(inputReal, 2000000) });
}

if (expectedTestPart2) {
  const outputTest = solvePart2(inputTest, 20);
  console.log("part2", {
  ...
  console.log({ solution: solvePart2(inputReal, 4000000) });
}
